...
ebbrt::EbbRef<ebbrt::SlabAllocator> ebbrt::SlabAllocator::Construct(
    size_t size) {
...
ebbrt::SlabAllocatorRoot::SlabAllocatorRoot(size_t size_in, size_t align_in)
    : align_(align::Up(std::max(align_in, sizeof(void*)), sizeof(void*))),
      ...
      order_(CalculateOrder(size_)),
      free_batch_(CalculateFreebatch(size_)),
...
ebbrt::SlabAllocator& ebbrt::SlabAllocatorRoot::GetCpuAllocator(
    size_t cpu_index) {
