...
//         addr,
// MakeReadyFuture<NetworkManager::TcpPcb>(std::move(pcb)).Share());
//   });
// }
...
//   // This may be part of a message we still haven't received all of, check if
// we
//   // queued anything
...
//       auto f2 = f.Then(MoveBind([](NetworkManager::TcpPcb pcb, Future<void>
// f) {
//                                   f.Get();
//                                   return pcb;
//                                 },
