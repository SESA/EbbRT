...
class EventStackFaultHandler : public ebbrt::VMemAllocator::PageFaultHandler {
 public:
  ...
  void HandleFault(ebbrt::idt::ExceptionFrame* ef, uintptr_t faulted_address)
      override {
...
extern "C" void SaveContextAndSwitch(
...
extern "C" void ActivateContextAndReturn(
    const ebbrt::EventManager::EventContext& context);
