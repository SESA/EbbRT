...
#ifndef BAREMETAL_SRC_INCLUDE_EBBRT_LOCALIDMAP_H_
#define BAREMETAL_SRC_INCLUDE_EBBRT_LOCALIDMAP_H_
...
namespace ebbrt {
class LocalIdMap : public CacheAligned {
 public:
...
#endif  // BAREMETAL_SRC_INCLUDE_EBBRT_LOCALIDMAP_H_
