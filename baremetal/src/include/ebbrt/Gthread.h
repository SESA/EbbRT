...
extern "C" void ebbrt_gthread_recursive_mutex_init(
...
extern "C" int ebbrt_gthread_recursive_mutex_destroy(
    __gthread_recursive_mutex_t* mutex);
...
extern "C" int ebbrt_gthread_recursive_mutex_lock(
    __gthread_recursive_mutex_t* mutex);
extern "C" int ebbrt_gthread_recursive_mutex_trylock(
    __gthread_recursive_mutex_t* mutex);
extern "C" int ebbrt_gthread_recursive_mutex_unlock(
    __gthread_recursive_mutex_t* mutex);
...
extern "C" int ebbrt_gthread_mutex_timedlock(
    __gthread_mutex_t* m,
    const __gthread_time_t* abs_timeout);
extern "C" int ebbrt_gthread_recursive_mutex_timedlock(
    __gthread_recursive_mutex_t* m,
    const __gthread_time_t* abs_time);
extern "C" int ebbrt_gthread_cond_signal(__gthread_cond_t* cond);
extern "C" int ebbrt_gthread_cond_timedwait(
